<header>
    <div class="container">
        <h1 class="text-center">¿Quieres reservar esta mascota?</h1>
    </div>
</header>
<br>
<div class="container">
    <section class="main row"> 
            <form name="formulario" class="form-horizontal" action="index.php?Mascota=<?php echo $_GET['Mascota'];?>&pagina=reservaMascota&numeroPagina=<?php echo $_GET['numeroPagina'];?>" method="post" enctype="multipart/form-data">
                <div class="col-md-6">
                    <?php
                ...
                <div class="form-group">
                    <input type="text" id="materialFormCardNameEx" class="form-control" name="codMascota" value="<?php echo $mascota->getCodMascota();?>" readonly style="display: none;">
