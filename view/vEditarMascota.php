<form name="formularioAlta" class="" action="index.php?pagina=editarMascota&Mascota=<?php echo $_GET['Mascota'];?>&numeroPagina=<?php echo $_GET['numeroPagina'];?>" method="post" style="width: 100%;">
    <fieldset>
        ...
        <div class="form-group row">
            <!-- Material input -->
            <label for="CodMascota" class="control-label col-sm-2">Codigo Mascota:</label>
            <div class="col-sm-10">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                    ...
                    <input type="text" class="form-control" id="alfabetico" name="nombre" value="<?php echo $mascota->getNombre();?>">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                    ...
                    <input type="text" class="form-control col-sm-1" id="float" name="edad" placeholder="" value="<?php echo $mascota->getEdad();?>">
