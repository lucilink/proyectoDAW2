...
<div class="container">
    <section class="main row"> 
        ...
        <div class="col-md-6">           
            <img src="/webroot/img/FormularioNuevaMascota.png" width="65%" height="65%" class="img-rounded img-responsive imgestrecha"/>                     
        </div>
        <div class="col-md-6">
            <form name="formulario" class="form-horizontal formularioizda" action="index.php?pagina=nuevaMascota" method="post" enctype="multipart/form-data">
               <div class="form-inline">
                    <input type="text" id="materialFormCardNameEx" class="form-control" placeholder="Codigo Mascota" name="codMascota" <?php if(isset($_POST['codMascota']) && empty($mensajeError['errorCodMascota'])){ echo 'value="',$_POST['codMascota'],'"';}?>>
                   ...
                   if(isset($mensajeError['errorMascotaRepetida'])){echo '<span style="color:red">'.$mensajeError['errorMascotaRepetida'].'</span>';} ?>
                    ...
                    <input type="text" id="materialFormCardNameEx" class="form-control" placeholder="Nombre" name="nombre" <?php if(isset($_POST['nombre']) && empty($mensajeError['errorNombre'])){ echo 'value="',$_POST['nombre'],'"';}?>>
                   <?php //si existe mensaje de error lo mostramos
               ...
               <div class="form-group">
                ...
                <br>
               <div class="form-inline">                 
                   <input type="text" id="materialFormCardNameEx" class="form-control" placeholder="Edad" name="edad" <?php if(isset($_POST['edad']) && empty($mensajeError['errorEdad'])){ echo 'value="',$_POST['edad'],'"';}?>>
                   <?php //si existe mensaje de error lo mostramos
